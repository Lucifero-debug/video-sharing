...
useEffect(()=>{
video && uploadFile(video,"videoFile")
},[video])

const handleUpload=async(e)=>{
e.preventDefault();
const res=await axios.post("/api/v1/video/publish",{...inputs,tags})
setOpen(false)
// console.log("Video upload response is:",res.data.statusCode)
...
<Description type="text" placeholder='Description' name='description' rows={8} onChange={handleChange}/>
